...
class StressTestManager:
    ...
    def start_test(self, config: Dict, socketio) -> str:
        """開始壓力測試"""
    ...
    def _run_stress_test(self, test_id: str, config: Dict, socketio):
        """執行壓力測試的主要邏輯"""
        try:
            # 更新狀態為運行中
            with self.lock:
            ...
            # 執行測試
            self._execute_test(test_id, config, socketio)
    ...
    def _execute_test(self, test_id: str, config: Dict, socketio):
        """執行具體的測試邏輯"""
        model = config['model']
            ...
            while True:
                try:
                    ...
                    with self.lock:
                        ...
                        self.active_tests[test_id]['results'] = results.copy()
...
if __name__ == "__main__":
    ...
    test_id = manager.start_test(test_config, None)
